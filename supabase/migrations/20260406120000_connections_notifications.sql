...
-- Adds connections table, notifications table, and profile enhancements
...
CREATE INDEX idx_connections_target ON public.connections (target_id, status);
CREATE INDEX idx_connections_accepted ON public.connections (requester_id, target_id) WHERE status = 'accepted';
...
-- ============================================================
-- 4. Helper function: get accepted connections for a user
-- ============================================================
...
-- ============================================================
-- 5. Helper function: search users
-- ============================================================
