        ...
        <div className="container px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10">
              Curated events. Real venues, real experiences, right now.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-10">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Creator-hosted events with full ticketing and support</p>
              </div>
            </div>
        ...
        <div className="container px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Turn your event idea into reality. Transparent pricing, full operational support.
            </p>
