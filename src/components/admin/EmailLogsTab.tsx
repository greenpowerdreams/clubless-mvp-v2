...
import { RefreshCw, Mail, AlertTriangle, CheckCircle, Clock, Search, BarChart3, List, Eye } from "lucide-react";
...
export function EmailLogsTab() {
  ...
  const openedCount = logs.filter((l) => l.opened_at !== null).length;
        ...
        <TabsContent value="logs" className="mt-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="glass rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-blue-400">{openedCount}</p>
            </div>
            <div className="glass rounded-xl p-4">
